...
namespace System
{
    public static class VinTypeExtensions
    {
        ...
        private static void AddTypeAndBaseTypesRecursively([NotNull] List<Type> types, [MaybeNull] Type type, bool includeObject, [MaybeNull] Type stoppingType = null)
        {
